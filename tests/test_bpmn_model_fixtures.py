...
def _bpmn_model_with_infinite_loop_and_AND() -> BPMNModel:
    bpmn_model = BPMNModel()
    bpmn_model._cached_search = False
    bpmn_model.add_event(BPMNNodeType.START_EVENT, "0", "Start")
    bpmn_model.add_event(BPMNNodeType.END_EVENT, "35", "End")
    bpmn_model.add_task("2", "A")
    bpmn_model.add_task("13", "B")
    bpmn_model.add_task("20", "C")
    bpmn_model.add_task("33", "D")
    bpmn_model.add_gateway(BPMNNodeType.EXCLUSIVE_GATEWAY, "29", "XOR-split")
    bpmn_model.add_gateway(BPMNNodeType.EXCLUSIVE_GATEWAY, "4", "XOR-join")
    bpmn_model.add_gateway(BPMNNodeType.EXCLUSIVE_GATEWAY, "6", "XOR-split")
    bpmn_model.add_gateway(BPMNNodeType.EXCLUSIVE_GATEWAY, "27", "XOR-join")
    bpmn_model.add_gateway(BPMNNodeType.PARALLEL_GATEWAY, "8", "AND-split")
    bpmn_model.add_gateway(BPMNNodeType.PARALLEL_GATEWAY, "25", "AND-join")
    bpmn_model.add_gateway(BPMNNodeType.EXCLUSIVE_GATEWAY, "11", "XOR-split")
    bpmn_model.add_gateway(BPMNNodeType.EXCLUSIVE_GATEWAY, "15", "XOR-join")
    bpmn_model.add_gateway(BPMNNodeType.EXCLUSIVE_GATEWAY, "18", "XOR-split")
    bpmn_model.add_gateway(BPMNNodeType.EXCLUSIVE_GATEWAY, "22", "XOR-join")
    bpmn_model.add_flow("1", "flow", "0", "2")
    bpmn_model.add_flow("3", "flow", "2", "4")
    bpmn_model.add_flow("5", "flow", "4", "6")
    bpmn_model.add_flow("7", "flow", "6", "8")
    bpmn_model.add_flow("9", "flow", "8", "11")
    bpmn_model.add_flow("12", "flow", "11", "13")
    bpmn_model.add_flow("14", "flow", "13", "15")
    bpmn_model.add_flow("16", "flow", "11", "15")
    bpmn_model.add_flow("17", "flow", "15", "25")
    bpmn_model.add_flow("10", "flow", "8", "18")
    bpmn_model.add_flow("19", "flow", "18", "20")
    bpmn_model.add_flow("21", "flow", "20", "22")
    bpmn_model.add_flow("23", "flow", "18", "22")
    bpmn_model.add_flow("24", "flow", "22", "25")
    bpmn_model.add_flow("26", "flow", "25", "27")
    bpmn_model.add_flow("28", "flow", "27", "29")
    bpmn_model.add_flow("30", "flow", "6", "27")
    bpmn_model.add_flow("31", "flow", "29", "4")
    bpmn_model.add_flow("32", "flow", "29", "33")
    bpmn_model.add_flow("34", "flow", "33", "35")
    return bpmn_model


def _bpmn_model_with_optional_AND_with_skipping_and_loop_branches() -> BPMNModel:
    bpmn_model = BPMNModel()
    bpmn_model._cached_search = False
    bpmn_model.add_event(BPMNNodeType.START_EVENT, "0", "Start")
    bpmn_model.add_event(BPMNNodeType.END_EVENT, "30", "End")
    bpmn_model.add_task("2", "A")
    bpmn_model.add_task("11", "B")
    bpmn_model.add_task("17", "C")
    bpmn_model.add_task("27", "D")
    bpmn_model.add_gateway(BPMNNodeType.PARALLEL_GATEWAY, "7", "AND-split")
    bpmn_model.add_gateway(BPMNNodeType.PARALLEL_GATEWAY, "23", "AND-join")
    bpmn_model.add_gateway(BPMNNodeType.EXCLUSIVE_GATEWAY, "4", "XOR-split")
    bpmn_model.add_gateway(BPMNNodeType.EXCLUSIVE_GATEWAY, "25", "XOR-join")
    bpmn_model.add_gateway(BPMNNodeType.EXCLUSIVE_GATEWAY, "9", "XOR-split")
    bpmn_model.add_gateway(BPMNNodeType.EXCLUSIVE_GATEWAY, "13", "XOR-join")
    bpmn_model.add_gateway(BPMNNodeType.EXCLUSIVE_GATEWAY, "19", "XOR-split")
    bpmn_model.add_gateway(BPMNNodeType.EXCLUSIVE_GATEWAY, "15", "XOR-join")
    bpmn_model.add_flow("1", "flow", "0", "2")
    bpmn_model.add_flow("3", "flow", "2", "4")
    bpmn_model.add_flow("5", "flow", "4", "7")
    bpmn_model.add_flow("6", "flow", "7", "9")
    bpmn_model.add_flow("10", "flow", "9", "11")
    bpmn_model.add_flow("12", "flow", "11", "13")
    bpmn_model.add_flow("14", "flow", "9", "13")
    bpmn_model.add_flow("21", "flow", "13", "23")
    bpmn_model.add_flow("8", "flow", "7", "15")
    bpmn_model.add_flow("16", "flow", "15", "17")
    bpmn_model.add_flow("18", "flow", "17", "19")
    bpmn_model.add_flow("20", "flow", "19", "15")
    bpmn_model.add_flow("22", "flow", "19", "23")
    bpmn_model.add_flow("24", "flow", "23", "25")
    bpmn_model.add_flow("29", "flow", "4", "25")
    bpmn_model.add_flow("26", "flow", "25", "27")
    bpmn_model.add_flow("28", "flow", "27", "30")
    return bpmn_model
